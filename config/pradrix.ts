export const PRADRIX_CONFIG = {
  name: "Pradrix",
  tagline: "AI Transformation Partner | AI Systems & Automation",
  headline: "The AI systems your business actually needs.",
  url: "https://pradrix.com/",
