...
export const kavachStoryData: KavachStoryData = {
  ...
  architecture: {
    hardware: [
      "Raspberry Pi 4 central edge server",
      "Arduino Uno microcontroller interface",
      "12V Geared Motor & Solenoid Lock via L298N H-Bridge driver",
      "Physical door prototype frame & deadbolt mechanism",
      "USB Microphone array with WebRTC VAD audio preprocessing",
    ],
    software: [
      "React dashboard for user voice registration and access monitoring",
      "Vosk speech-to-text keyword trigger engine",
      "Resemblyzer deep learning speaker voiceprint verification model",
      "Flask REST API backend with JWT authentication & MongoDB persistence",
      "Serial communication protocol (Raspberry Pi to Arduino)",
      "Arduino C++ state-machine firmware for motor actuation",
    ],
    flow: [
      "Microphone Audio Capture & WebRTC VAD",
      "Vosk Keyword Recognition",
      "Resemblyzer Biometric Speaker Verification",
      "Flask REST API & MongoDB Validation",
      "Serial Authorization Signal to Arduino",
      "L298N Motor Driver Actuation & Physical Unlock",
    ],
  },
  steps: [
    {
