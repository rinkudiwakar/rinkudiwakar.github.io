  ...
  return (
    <div className="flex flex-col items-start gap-2 select-none">
      <div className="flex flex-col items-center gap-1.5 -rotate-3 select-none">
        ...
        <div className="w-7 h-7 rounded-full border border-[var(--foreground)] opacity-70 flex items-center justify-center text-[var(--foreground)]">
          <ArrowDown className="w-3.5 h-3.5 scroll-arrow-bob" />
        </div>
      </div>
    </div>
  );
